...
#Baselines
CUDA_VISIBLE_DEVICES=0 python main_baselines.py --baseline dua --config cfgs/baselines/tta/tta_dua.yaml --dataset <dataset_name>  --ckpts <path/to/pretrained/model>
CUDA_VISIBLE_DEVICES=0 python main_baselines.py --baseline ttt --config cfgs/baselines/tta/tta_rotnet.yaml --dataset <dataset_name>  --ckpts <path/to/pretrained/model>
CUDA_VISIBLE_DEVICES=0 python main_baselines.py --baseline t3a --config cfgs/baselines/tta/tta_t3a.yaml --dataset <dataset_name>  --ckpts <path/to/pretrained/model>
CUDA_VISIBLE_DEVICES=0 python main_baselines.py --baseline shot --config cfgs/baselines/tta/tta_shot.yaml --dataset <dataset_name>  --ckpts <path/to/pretrained/model>
CUDA_VISIBLE_DEVICES=0 python main_baselines.py --baseline tent --config cfgs/baselines/tta/tta_tent.yaml --dataset <dataset_name>  --ckpts <path/to/pretrained/model>
