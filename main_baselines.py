...
from tools.tta import tta_tent, tta_shot, tta_t3a
...
def main(args):
    ...
    if args.baseline == 'shot':
        ...
        args.batch_size = 128
        args.split = 'test'
        tta_shot(args, config)

    if args.baseline == 't3a':
        args.t3a_filter_k = 50
        args.num_classes = 55
        args.batch_size = 128
        args.split = 'test'
        tta_t3a(args, config)
    ...
    if args.baseline == 'ttt':
        args.split = 'test'
        tta_rotnet(args, config)
